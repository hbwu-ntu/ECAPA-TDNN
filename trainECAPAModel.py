...
parser.add_argument(
    "--test_step", type=int, default=1, help="Test and save every [test_step] epochs"
)
...
parser.add_argument(
    "--sim_eval_list",
    type=str,
    default="/data08/VoxCeleb1/sim_trial.txt",
    help="The path of the similarity evaluation list",
)
parser.add_argument(
    "--eval_path",
    type=str,
...
parser.add_argument(
    "--initial_model", type=str, default="", help="Path of the initial_model"
)
...
## Command
parser.add_argument(
    "--eval", dest="eval", action="store_true", help="Only do evaluation"
)

parser.add_argument(
    "--eval_sim", dest="eval_sim", action="store_true", help="Only do speaker similarity evaluation"
)
...
## Only do speaker similarity calculation, the initial_model is necessary
if args.eval_sim == True:
	s = ECAPAModel(**vars(args))
	print("Model %s loaded from previous state!"%args.initial_model)
	s.load_parameters(args.initial_model)
	SIM = s.speaker_similarity(eval_list = args.sim_eval_list)
	print("Similarity: %2.2f%%"%(SIM * 100))
	quit()
...
while 1:
    ...
    if epoch % args.test_step == 0:
        ...
        EERs.append(
            s.eval_network(eval_list=args.eval_list, eval_path=args.eval_path)[0]
        )
        print(
